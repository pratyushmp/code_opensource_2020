...
import com.example.androidarch.databinding.ActivitySignUpBinding
...
class SignUpActivity : AppCompatActivity(), AuthListener, KodeinAware {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var binding : ActivitySignUpBinding = DataBindingUtil.setContentView(this, R.layout.activity_sign_up)
